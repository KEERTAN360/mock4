...
export default function LoginPage() {
  ...
  const handleLogin = () => {
    if (username === "keertan" && password === "12345") {
      localStorage.setItem("isLoggedIn", "true")
      localStorage.setItem("username", username)
      router.push("/")
    } else {
      setError("Invalid credentials. Use username: keertan, password: 12345")
    }
  }
      ...
      >
        ...
        <div className="space-y-6">
          ...
          <Button
            ...
            style={{
              boxShadow: "0 0 30px rgba(59, 130, 246, 0.7), 0 0 50px rgba(59, 130, 246, 0.4)",
            }}
          >
            Sign In
          </Button>
        ...
        <div className="mt-8 text-center">
          <p className="text-xs text-gray-400">Demo credentials: keertan / 12345</p>
        </div>
      </Card>
    </div>
  )
