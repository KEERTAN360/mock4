    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      {showSidePanel && (
        <>
          ...
          <div className="fixed top-0 right-0 h-full w-80 bg-white border-l border-gray-200 shadow-2xl z-50 transform transition-transform duration-300 ease-in-out">
            <div className="p-6">
              ...
              <div className="space-y-4">
                <Button
                  variant="ghost"
                  className="w-full justify-start text-left p-4 h-auto text-gray-700 hover:bg-gray-100"
                >
      ...
      <div className="flex-1 pb-20">
        ...
        <div className="mb-8 px-4">
          ...
          <div
            ...
            className="placard-3d flex gap-4 overflow-x-auto pb-2 bg-gradient-to-r from-primary to-accent rounded-3xl p-4 shadow-md cursor-pointer scrollbar-hide"
          >
